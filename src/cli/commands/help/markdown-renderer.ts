...
// Pre-compiled regex for HTML unescaping to avoid dynamic RegExp allocations on every call
...
function unescape(text: string): string {
  // Single pass regex replacement using a lookup map to avoid dynamic RegExp allocation per key
  return text.replace(
    HTML_UNESCAPE_RE,
